...
public class Chaining {
    ...
    public int insertKey(int key){
    	int collision;
        int hashNum;
        hashNum = chain(key); //Hash function
        
        ArrayList<Integer> chainTable; //adds key into a linked list at the hashNum index
        chainTable = Table.get(hashNum);
        collision = chainTable.size();
        chainTable.add(key);
